...
export class CodexTmuxProvider implements WorkerProvider {
  ...
  async resolveConflict(session: string, worktree: string, branch: string, _resumeSessionId?: string): Promise<void> {
    const instruction = [
