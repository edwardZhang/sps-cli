 ...
 * Task-specific info (seq, branch) is injected via prompt at worker launch time.
 */
function generateWorkerRules(ctx: ProjectContext): string {
  return `# Worker Rules (auto-generated by sps doctor --fix)
#
# This file defines rules for the Claude Code worker operating in this
# repository.
#
...
4. git add, commit, and push to the current branch
